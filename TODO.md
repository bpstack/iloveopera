...
### 1.1 Abrir PDF
- [ ] 🖥️ Abrir PDF desde botón "Abrir PDF" → se renderiza
- [ ] 📱 Abrir PDF vía SAF (selector Android) → bytes → render (R13, nunca validado en device real)
- [ ] 🖥️📱 Abrir un segundo PDF reemplaza el primero (single-document) y limpia anotaciones
- [ ] 🖥️📱 Cancelar el selector no rompe ni muestra error feo
- [ ] 🖥️📱 PDF inexistente / corrupto → mensaje claro, no crash

### 1.2 Visualización multipágina
- [ ] 🖥️📱 Todas las páginas se ven, scroll fluido
- [ ] 🖥️📱 Páginas de distinto tamaño/orientación se ven correctas (R5)
- [ ] 🖥️📱 PDF grande (50+ pág.) no congela ni agota memoria (R9)

### 1.3 Navegación entre páginas
- [ ] 🖥️ Botones anterior/siguiente funcionan
- [ ] 📱 Botones anterior/siguiente en barra inferior funcionan ✅(fix: barra inferior nueva)
- [ ] 🖥️📱 Indicador "N / M" se actualiza al hacer scroll
- [ ] 🖥️📱 "Ir a página" (diálogo) salta correctamente
- [ ] 🖥️📱 Límites: no pasa de la última ni antes de la primera

### 1.4 Zoom — PRIORIDAD (roto en móvil)
- [ ] 🖥️ Zoom con botones +/− y campo de %
- [ ] 🖥️ Zoom con Ctrl+rueda del ratón
- [ ] 🖥️ "Ajustar a página" funciona
- [ ] 📱 Zoom con botones +/−/ajustar en barra inferior ✅(fix: barra inferior nueva)
- [~] 🐞 📱 **Pinch-to-zoom + pan sobre el contenido** (Android real). Causa raíz:
...
- [ ] 📱 Pan con 1 dedo desplaza el PDF (reportado OK por usuario, confirmar)
- [ ] 🖥️📱 El % mostrado nunca se desincroniza del zoom real

### 1.5 Miniaturas
- [ ] 🖥️ Barra lateral de miniaturas visible y clicable (solo desktop/ancho)
- [ ] 🖥️ Click en miniatura salta a esa página
- [ ] 📱 Confirmar decisión: ¿miniaturas ocultas en móvil a propósito? (ahora sí lo están)
...
### 2.1 Añadir texto
- [ ] 🖥️ Herramienta texto → click coloca → diálogo → texto aparece donde se hizo click
- [ ] 📱 Herramienta texto → tap coloca → diálogo → texto aparece donde se hizo tap
- [ ] 🖥️📱 Texto vacío/cancelado no crea anotación
- [ ] 🖥️📱 Posición fiel al zoom (cambiar zoom no descoloca el texto) — R5

### 2.2 Editar texto
- [ ] 🖥️ Doble-click sobre texto reabre diálogo de edición
- [ ] 📱 Doble-tap sobre texto reabre diálogo de edición
- [ ] 🖥️📱 Borrar todo el texto en edición → elimina la anotación

### 2.3 Estilo de fuente
- [ ] 🖥️ Panel derecho: cambiar familia/tamaño/color afecta en vivo
- [ ] 📱 Bottom-sheet (FAB propiedades): cambiar familia/tamaño/color afecta en vivo
- [ ] 🖥️📱 Las 5 fuentes del set se ven distintas y se embeben al exportar

### 2.4 Mover texto
- [ ] 🖥️ Arrastrar texto seleccionado lo mueve, suelta donde toca
- [ ] 📱 Arrastrar texto con el dedo lo mueve
- [ ] 🖥️📱 Mover no descoloca respecto al cursor/dedo ✅(fix: drag elevado al
...
- [ ] 🐞 🖥️📱 **Handle inferior-derecho del cuadro de texto** — usuario: "solo ancho al
...
- [ ] 🖥️📱 Crear rect, por defecto blanco, tapa el contenido
- [ ] 🖥️📱 Cambiar color y opacidad en vivo
- [ ] 🖥️📱 Redimensionar rect (esto funciona OK según usuario — usar de referencia)
- [ ] 🖥️📱 Mover y eliminar rect
...
|---|-----|-----------|--------|
| B1 | Pan/zoom no funciona sobre el contenido | 📱 | 🟡 fix: mano=IgnorePointer→pdfrx recibe gesto; reverificar en device |
| B2 | Resize cuadro de texto incorrecto | 🖥️📱 | 🟡 fix aplicado, falta reverificar en device |
| B3 | App bar móvil recortaba guardar/exportar | 📱 | 🟢 corregido (barra inferior) |
| B4 | FAB propiedades podría tapar barra inferior | 📱 | 🟡 verificar |
